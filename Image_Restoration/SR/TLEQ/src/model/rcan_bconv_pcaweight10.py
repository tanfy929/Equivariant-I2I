...
class RCAB(nn.Module):
    def __init__(
        ...
        bias=True, bn=False, act=nn.ReLU(True), res_scale=1.0, iniScale=1.0):
...
class ResidualGroup(nn.Module):
    def __init__(self, tranNum, inP, Smooth, n_feat, kernel_size, reduction, act, res_scale, n_resblocks, iniScale=1.0):
        ...
        modules_body = []
        modules_body = [
            RCAB(tranNum, inP, Smooth, n_feat, kernel_size, reduction, bias=True, bn=False, act=nn.ReLU(True), res_scale=1.0, iniScale = iniScale) \
